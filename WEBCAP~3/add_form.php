<html>
<head><title> 회원 가입 </title><style type="text/css">
@import url(//fonts.googleapis.com/earlyaccess/nanumpenscript.css);
a { font-family:'Nanum Pen Script', cursive; font-size:22px; text-decoration:none } 
</style>
</head>
<body>
...
window.open('id_chk.php?fuserid='+user_form.fuserid.value,'IDwin', 'width=600, height=400');
	}
  }
</script>
