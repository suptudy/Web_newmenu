<?php
	...
	$sql = "select * from tb_menus where menu_brand='ediya'";                          // 테이블 검색 질의
...
<head>
    ...
    <title>신메뉴의 정석/이디야</title> <!-- 밑의 링크 추가함 -->
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='ediya' and menu_type='coffee'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='ediya' and menu_type='beverage'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='ediya' and menu_type='blending_tea'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);

    while ($rows=mysqli_fetch_array($result)) {   
        if($rows[4] === "blending_tea") {
            echo "<td><center><img src='$rows[3]' style='max-width: 100%; height: auto;'/></center></td>"; 
            //메뉴 사진
            echo "</tr>";
            echo "<tr align='center'>";
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='ediya' and menu_type='flatccino'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='ediya' and menu_type='shake_ade'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='ediya' and menu_type='ice_flakes'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);

    while ($rows=mysqli_fetch_array($result)) {   
        if($rows[4] === "ice_flakes") {
            echo "<td><center><img src='$rows[3]' style='max-width: 100%; height: auto;'/></center></td>"; 
            //메뉴 사진
            echo "</tr>";
            echo "<tr align='center'>";
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='ediya' and menu_type='rtd'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='ediya' and menu_type='bread'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='ediya' and menu_type='dessert'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='ediya' and menu_type='cookie_etc'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);

    while ($rows=mysqli_fetch_array($result)) {   
        if($rows[4] === "cookie_etc") {
            echo "<td><center><img src='$rows[3]' style='max-width: 100%; height: auto;'/></center></td>"; 
            //메뉴 사진
            echo "</tr>";
            echo "<tr align='center'>";
