<?php
	...
	$sql = "select * from tb_menus where menu_brand='starbucks'";                          // 테이블 검색 질의
...
<head>
    ...
    <title>신메뉴의 정석/스타벅스</title> <!-- 밑의 링크 추가함 -->
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='starbucks' and menu_type='drink'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);
...
<table  width="400" border="1" align="center">  <!확인용 border=1>
       <tr align="center">
<?php
	$sql = "select * from tb_menus where menu_brand='starbucks' and menu_type='food'";                          // 테이블 검색 질의
	$result = mysqli_query ($connect, $sql);              // 질의 수행
    $count = mysqli_num_fields ($result);
